...
export function BirthdayWishStage({
  cake,
  onComplete,
}: {
  cake: CakeState;
  ...
  const handleMakeWish = () => {
    ...
    setTimeout(() => {
      ...
      setWishMessage(
        wishMessages[Math.floor(Math.random() * wishMessages.length)]
      );
  ...
  // After the wish message has had a moment to land, move automatically
  // into the final celebration instead of making the user click another button.
  useEffect(() => {
  ...
  return (
    <div
      className={`relative w-full min-h-screen overflow-hidden flex flex-col items-center justify-center px-4 py-6 transition-all duration-1000
      ${
        dimmed
          ? 'bg-gradient-to-b from-sky-300 via-lavender-200 to-cream-200'
          : 'bg-gradient-to-b from-lavender-100 via-cream-100 to-sky-100'
      }`}
    >
      {dimmed && (
      ...
      <div
        className="absolute top-[15%] right-[15%] w-5 animate-sparkle opacity-50"
        style={{ animationDelay: '1s' }}
      >
        <Star className="w-full" color="#fff" />
      </div>
      <div
        className="absolute top-[25%] left-[20%] w-4 animate-sparkle opacity-40"
        style={{ animationDelay: '0.5s' }}
      >
        <Star className="w-full" color="#f0b4c4" />
      </div>
      <div
        className="absolute top-[20%] right-[25%] w-4 animate-sparkle opacity-40"
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
        {phase === 'intro' && (
          <div className="animate-fade-in">
            <h2
              className="font-hand text-4xl md:text-6xl text-sky-500 mb-4 text-shadow-soft"
        ...
        {(phase === 'lighting' || phase === 'ready') && (
          <div className="animate-fade-in w-full flex flex-col items-center">
            <h2
              className="font-hand text-3xl md:text-5xl text-sky-500 mb-2 text-shadow-soft"
              style={{ fontWeight: 600 }}
            >
              Make a wish.
            </h2>
            ...
            {phase === 'ready' && (
              <div className="animate-fade-in">
                <p
                  className="font-hand text-2xl text-sky-500 mb-4"
                  style={{ fontWeight: 600 }}
                >
                  Close your eyes...
                </p>
        ...
        {phase === 'wishing' && (
          <div className="text-center animate-fade-in">
            ...
            <p
              className="font-hand text-2xl md:text-3xl text-sky-500 animate-fade-in"
              style={{ fontWeight: 600 }}
            >
              ...
            </p>
        ...
        {phase === 'done' && (
          <div className="text-center animate-fade-in">
            ...
            <div className="relative inline-block">
              ...
              <div
                className="absolute -top-4 -right-8 w-6 animate-sparkle"
                style={{ animationDelay: '0.3s' }}
              >
                <Sparkle className="w-full" />
              </div>
              <h2
                className="font-hand text-3xl md:text-5xl text-blush-500 mb-2 text-shadow-soft px-4"
